...
async def cmd_start(message: Message, bot: Bot):
    ...
    welcome_text = f"""🤖 <b>ربات پاسخگوی فنی و جستجوی تجربیات گروه</b>

این ربات به آرشیو گفتگوها، گزارش‌های عیب‌یابی و تجربیات اعضای گروه متصل است و به پرسش‌های فنی با <b>استناد مستقیم به پیام‌های منبع</b> پاسخ می‌دهد.

💡 <b>نحوه استفاده:</b>
• <b>چت خصوصی:</b> سوال یا شرح مشکل فنی را مستقیماً ارسال کنید.
• <b>گروه:</b> با منشن کردن ربات یا ریپلای روی پیام‌های آن سوال را مطرح کنید:
